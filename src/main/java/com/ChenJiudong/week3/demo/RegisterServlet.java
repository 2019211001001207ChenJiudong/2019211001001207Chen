package com.ChenJiudong.week3.demo;
...
public class RegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String name,password,email,gender,birthdate;
        ...
        try {
            ...
            String ADDdbRequire = "insert into usertable values('" + name + "','" + password + "','" + email + "','" + gender + "','" + birthdate + "')";
            ((java.sql.Statement) createDbStatement).executeUpdate(ADDdbRequire);
            //String dbRequire = "select * from usertable";
           // ResultSet resultDb = ((java.sql.Statement) createDbStatement).executeQuery(dbRequire);
            //while (resultDb.next()) {
